...
export default function ExampleControls({ children }: ControlsProps) {
  ...
  >('none')
  const [renderLineOrAreaSeries, setRenderLineOrAreaSeries] = useState<
    'line' | 'area' | 'none'
  >('area')
  ...
  const canRenderLineOrArea =
    renderBarStackOrGroup === 'bar' || renderBarStackOrGroup === 'none'
  ...
  return (
    <>
      {children({
        ...
        renderHorizontally,
        renderAreaSeries:
          canRenderLineOrArea && renderLineOrAreaSeries === 'area',
        renderLineSeries:
          canRenderLineOrArea && renderLineOrAreaSeries === 'line',
        ...
        <div>
          ...
          <label>
            <input
              ...
              checked={
                renderLineOrAreaSeries === 'none' || !canRenderLineOrArea
              }
            />
            none
          </label>
          ...
          <label>
            <input
              type="radio"
              disabled={
                !canRenderLineOrArea || renderLineOrAreaSeries === 'none'
              }
